<?php
// Check session_start() condition in framework environment
if (!isset($_SESSION)) {
    session_start();
}
...
// Check $_SERVER['HTTP_HOST'] key is existed because error in CLI mode
...
$config = array(
    ...
    */
    ...
    'ellipsis_title_after_first_row'          => config('files.ellipsis_title_after_first_row'),
