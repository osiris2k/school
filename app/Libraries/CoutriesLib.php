...
{
    /**
     * Generate country with continent
     *
     * @return array
     */
    public static function getCountryWithContinent()
    {
        $countries = self::getCountryList();
        $returnArray = [];
        $continent_code = null;
        foreach ($countries as $countryCode => $country) {
            switch (trim($country['continent'])) {
                case'Asia':
                    $continent_code = 'AS';
                    break;
                case'Antarctica':
    ...
    // TODO move Country array list to country config file
    /**
     * Generate country
     *
     * @return array
