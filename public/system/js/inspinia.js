...
function WinMove() {
    ...
    $(element).sortable({
        stop: function(event,ui){            
            ...
            var type = $(ui_sortables[0]).data('type');

            var base_url = window.location.protocol+'//'+document.domain;
            $.get( base_url+"/system/order/"+type ,{'sort[]': tmp_sort},function(data){
