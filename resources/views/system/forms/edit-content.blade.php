...
<div class="col-lg-12">
	<div class="ibox float-e-margins">
		<div class="ibox-title">
			<h5>All form elements <small>set obcject</small></h5>
		...
		{!! Form::open(array('url'=>$action,'method'=>$method,'onsubmit'=>'javascript:has_action=false','class'=>'form-horizontal','files'=>true))!!}
			<div class="form-group">
				<div class="col-md-6">
					...
					<input type="text" name="name" class="form-control" value="{{ $obj->name or old('name') }}" requied>
					<input type="hidden" name="content_object_id" value="{{$content_object->id}}" requied>
				</div>
			</div>
			<div class="form-group">
				<div class="col-md-6">
					...
					<select name="parent_id" class="form-control">
						...
						@foreach($contents as $content)
							@if(isset($obj) ? $obj->parent_site : '' ==$content->id)
			...
			<div class="form-group action-zone">
				<div class="col-sm-6 text-right">
					<a href="{{url('system/contents/'.$content_object->id.'-'.$content_object->name)}}" class="btn btn-white">Cancel</a>
